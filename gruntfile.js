...
module.exports = function(grunt) {
        ...
        uglify: {
            ...
            iconset: {
                files: {
                    ...
                    'temp/js/iconset/iconset-fontawesome-6-all.min.js':     ['src/js/iconset/iconset-fontawesome-6-all.js'],
                    'temp/js/iconset/iconset-fontawesome-7-all.min.js':     ['src/js/iconset/iconset-fontawesome-7-all.js'],
        ...
        concat: {
            ...
            iconsetJS: {
                ...
                src: [
                    ...
                    'src/js/iconset/iconset-fontawesome-6-all.js',
                    'src/js/iconset/iconset-fontawesome-7-all.js',
            ...
            iconsetJSMin: {
                ...
                src: [
                    ...
                    'temp/js/iconset/iconset-fontawesome-6-all.min.js',
                    'temp/js/iconset/iconset-fontawesome-7-all.min.js',
    ...
    // Verification task for Font Awesome 6 icon list
    grunt.registerTask('verifyFa6', 'Verify Font Awesome 6 free icon coverage', function() {
        var done = this.async();
        var spawn = require('child_process').spawn;
        var args = ['util/verify-fa6.js'];
        if (grunt.option('strict')) {
            args.push('--fail-on-missing');
        }
        var proc = spawn(process.execPath, args, { stdio: 'inherit' });
        proc.on('close', function(code) {
            if (code !== 0) {
                grunt.log.error('Font Awesome 6 verification failed.');
                return done(false);
            }
            grunt.log.ok('Font Awesome 6 verification completed.');
            done();
        });
    });
